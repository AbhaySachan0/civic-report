  ...
  return (
    <section className="py-20 relative transition-colors duration-500 bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Additional Features */}
        <div className="bg-gradient-to-r from-blue-50 to-orange-50 dark:bg-gray-800 rounded-3xl p-8 sm:p-12 border border-orange-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalFeatures.map((feature, idx) => (
              <div key={idx} className="flex items-center space-x-3 bg-white dark:bg-gray-700 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200 border-l-4 border-orange-300 dark:border-gray-600">
